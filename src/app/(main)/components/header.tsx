...
export const Header = ({ className }: Props) => {
  return (
    <div className={cn(className)}>
      <header className="h-[107px] pl-[29px] pr-[65px] flex items-center justify-between w-full border-gray-1 border-b-[2px]">
        <Input />

        <div className="flex items-center gap-[12px] fixed right-1/2 translate-x-1/2">
